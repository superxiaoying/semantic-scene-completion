...
C.volna = '/mnt/lustre/chenxiaokang/'
...
C.dataset_path = osp.join(C.volna, 'DATA/NYUDepth_new')
...
C.bn_eps = 1e-5
C.bn_momentum = 0.1
C.pretrained_model = C.volna + 'DATA/.torch/pytorch-weight/resnet101_v1c.pth'
